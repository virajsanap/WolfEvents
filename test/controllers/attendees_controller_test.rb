...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { address: @attendee.address, credit_card: @attendee.credit_card, email: @attendee.email, name: @attendee.name, password: @attendee.password, phone: @attendee.phone } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { address: @attendee.address, credit_card: @attendee.credit_card, email: @attendee.email, name: @attendee.name, password: @attendee.password, phone: @attendee.phone } }
